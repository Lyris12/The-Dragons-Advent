...
function ref.initial_effect(c)
	...
	e5:SetCategory(CATEGORY_POSITION+CATEGORY_DAMAGE+CATEGORY_DESTROY)
...
function ref.operation(e,tp,eg,ep,ev,re,r,rp)
	local tc=Duel.GetFirstTarget()
	if tc:IsFacedown() and tc:IsRelateToEffect(e) and Duel.ChangePosition(tc,POS_FACEUP_ATTACK)~=0 then
		Duel.BreakEffect()
